...
class UserController {
    static async getAllUsers(req: Request, res: Response, next: NextFunction) {
        ...
        res.status(200).json({ error: false, code: 200, data: users, message: 'Users fetched successfully' });
    }
    ...
    static async getUserById(req: Request, res: Response, next: NextFunction) {
        ...
        res.status(200).json({ error: false, code: 200, data: user, message: `User of ID ${userId} fetched successfully` });
    }
